...
const howto = () => {
  ...
  <link href="https://www.almemater.com/alme-maters-favicon.ico" rel="shortcut icon" />
        ...
        <div className={styles.content}>
          Visit <a href="https://airdrop.ultimatedigits.com" className={styles.link}>airdrop.ultimatedigits.com</a> and connect any wallet to start farming <span className={styles.highlight}>$ALME</span> by completing the specified tasks. Additionally, link your Discord account and join the Alme Mater Community Server for Discord-related tasks. If you&apos;re already a server member, still connect your Discord to claim your Alme Points.
        </div>
        <div className={styles.content}>
